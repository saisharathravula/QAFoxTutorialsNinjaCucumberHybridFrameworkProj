...
public class ElementUtils {
	...
	public String getTexFromElement(WebElement element,long durationInSeconds) {
	...
	public boolean getDisplayStatusOfElement(WebElement element,long durationInSeconds) {
